...
class  Maquina {
   ...
   void line(){
		int x1,y1,x2,y2;
		y2=(int)((Double)pila.pop()).doubleValue();
		x2=(int)((Double)pila.pop()).doubleValue();
		y1=(int)((Double)pila.pop()).doubleValue();
		x1=(int)((Double)pila.pop()).doubleValue();
		if(g!=null){
			(new Linea(x1, y1, x2, y2) ).dibuja(g);
		}
   ...
   void circulo(){
      ...
      r=(int)((Double)pila.pop()).doubleValue();
      if(g!=null){
         (new Circulo(x, y, r)).dibuja(g);
      }
   }
   void rectangulo(){
	   int x,y,w,h;
		h=(int)((Double)pila.pop()).doubleValue();
		w=(int)((Double)pila.pop()).doubleValue();
		y=(int)((Double)pila.pop()).doubleValue();
		x=(int)((Double)pila.pop()).doubleValue();
      if(g!=null){
         (new Rectangulo(x, y, w, h )).dibuja(g);
      }
   }
   void draw(){
      Simbolo s;
